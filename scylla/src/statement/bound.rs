...
impl StatementBinder {
    pub(crate) fn new(prepared: PreparedStatement) -> Self {
        Self { prepared }
    }
    ...
    pub fn appending_binder(self) -> AppendingStatementBinder {
    ...
    pub fn by_index_binder<'value>(
        self,
        _any_value: &'value dyn SerializeValue,
    ) -> ByIndexStatementBinder<'value> {
    ...
    pub fn by_name_binder<'value>(
        self,
        _any_value: &'value dyn SerializeValue,
    ) -> ByNameStatementBinder<'value> {
...
#[derive(Debug)]
pub struct AppendingStatementBinder {
    prepared: PreparedStatement,
    values: SerializedValues,
}

impl AppendingStatementBinder {
    ...
    pub fn finish(self) -> Result<BoundStatement, AppendingStatementBinderError> {
...
/// by their index.
#[derive(Debug)]
pub struct ByIndexStatementBinder<'value> {
    prepared: PreparedStatement,
    values: Vec<Option<DynValue<'value>>>,
}

impl<'value> ByIndexStatementBinder<'value> {
    ...
    pub fn finish(self) -> Result<BoundStatement, ByIndexStatementBinderError> {
        let Self { prepared, values } = self;
...
/// by their name.
#[derive(Debug)]
pub struct ByNameStatementBinder<'value> {
    prepared: PreparedStatement,
    values: Vec<Option<DynValue<'value>>>,
}

impl<'value> ByNameStatementBinder<'value> {
    ...
    /// Actually serializes the values and checks if all required values are provided.
    /// If any value is missing, it returns an error.
    pub fn finish(self) -> Result<BoundStatement, ByNameStatementBinderError> {
        let Self { prepared, values } = self;

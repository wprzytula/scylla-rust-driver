...
impl QueryResult {
    ...
    /// (e.g. it was an `INSERT`), or the response is of incorrect type.
    ...
    #[inline]
    pub fn column_specs<'res>(&'res self) -> Option<ColumnSpecs> {
        self.raw_rows
            .as_ref()
    ...
    /// Paging state of the query that was reached after performing this request.
    #[inline]
...
mod tests {
    ...
    fn test_query_result() {
        ...
        fn sample_result_metadata(cols: usize) -> ResultMetadata {

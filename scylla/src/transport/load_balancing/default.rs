...
/// Statement type, used to enable specific load balancing patterns for certain cases.
///
/// Currently, there a distinguished case of LWT statements, which should always be routed
/// to replicas in the deterministic order to avoid Paxos conflicts. Other statements

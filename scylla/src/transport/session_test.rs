...
async fn test_tracing_query_iter(session: &Session, ks: String) {
    ...
    let untraced_typed_row_iter = untraced_query_pager.rows_stream::<(&str,)>().unwrap();
    ...
    let traced_typed_row_stream = traced_query_pager.rows_stream::<(&str,)>().unwrap();
...
async fn test_tracing_execute_iter(session: &Session, ks: String) {
    ...
    let untraced_typed_row_stream = untraced_query_pager.rows_stream::<(&str,)>().unwrap();
